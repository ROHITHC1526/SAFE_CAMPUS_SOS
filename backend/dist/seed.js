...
async function seed() {
    ...
    const password = await bcryptjs_1.default.hash('Student@123', 12);
    const secPass = await bcryptjs_1.default.hash('Security@123', 12);
    const adminPass = await bcryptjs_1.default.hash('Admin@123', 12);
    // ─── Users ────────────────────────────────────────────────────
    ...
    // ─── Heatmap Data ──────────────────────────────────────────────
    const heatmapPoints = [
        { latitude: 16.4420, longitude: 80.6225, intensity: 0.8, category: 'MEDICAL', hour: 10, dayOfWeek: 1 },
        { latitude: 16.4422, longitude: 80.6232, intensity: 0.6, category: 'HARASSMENT', hour: 18, dayOfWeek: 3 },
        { latitude: 16.4428, longitude: 80.6228, intensity: 0.5, category: 'THEFT', hour: 13, dayOfWeek: 5 },
        { latitude: 16.4435, longitude: 80.6240, intensity: 0.7, category: 'RAGGING', hour: 22, dayOfWeek: 6 },
        { latitude: 16.4440, longitude: 80.6235, intensity: 0.4, category: 'ACCIDENT', hour: 16, dayOfWeek: 2 },
        { latitude: 16.4419, longitude: 80.6226, intensity: 0.9, category: 'VIOLENCE', hour: 23, dayOfWeek: 0 },
        { latitude: 16.4425, longitude: 80.6230, intensity: 0.3, category: 'FIRE', hour: 11, dayOfWeek: 4 },
        { latitude: 16.4418, longitude: 80.6220, intensity: 0.5, category: 'OTHER', hour: 14, dayOfWeek: 1 },
    ];
